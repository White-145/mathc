...
struct vec2 svec2_slide(struct vec2 v0, struct vec2 normal) {
    struct vec2 result;
    vec2_slide((mfloat_t *)&result, (const mfloat_t *)&v0, (const mfloat_t *)&normal);
    return result;
}

struct vec2 svec2_reflect(struct vec2 v0, struct vec2 normal) {
    struct vec2 result;
    vec2_reflect((mfloat_t *)&result, (const mfloat_t *)&v0, (const mfloat_t *)&normal);
    return result;
}
...
struct vec2 *psvec2_slide(struct vec2 *result, const struct vec2 *v0, const struct vec2 *normal) {
    return (struct vec2 *)vec2_slide((mfloat_t *)result, (const mfloat_t *)v0, (const mfloat_t *)normal);
}

struct vec2 *psvec2_reflect(struct vec2 *result, const struct vec2 *v0, const struct vec2 *normal) {
    return (struct vec2 *)vec2_reflect((mfloat_t *)result, (const mfloat_t *)v0, (const mfloat_t *)normal);
}
